...
details:
  References:
    - '[1] Harvard Art Museum [AI Explorer](https://ai.harvardartmuseums.org/){:target="_blank"}.'
    ...
    - '[4] metaLAB [Curatorial A(i)gents](https://mlml.io/p/curatorial-aigents/){:target="_blank"}.'
  Exhibitions:
    - "2024: Arquivo e Memória do Dia 8 de Janeiro de 2023, Arquivo Histórico Municipal - São Paulo, BR"
  Events:
    - "2026: AI and Artworks - Vienna, AT"
    - "2026: Association for Art History annual conference - Cambridge, UK"
  Publications:
    - "2026: Guia dos arquivos que não existem. Universidade de São Paulo, São Paulo, BR"
---
