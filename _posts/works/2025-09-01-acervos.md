...
A prototype to navigate these collections and create visualizations is available [here](https://acervos-digitais.github.io/acervos-interface-R1/en/){:target="_blank"}.
